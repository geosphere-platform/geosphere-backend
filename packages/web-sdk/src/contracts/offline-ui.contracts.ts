...
export const OFFLINE_UI_COMPONENTS: Record<string, GeoSphereComponentDefinition> = {
...
export const OFFLINE_READY_MADE_SCREENS: Record<string, GeoSphereScreenDefinition> = {
  OFFLINE_MAPS_SCREEN: {
