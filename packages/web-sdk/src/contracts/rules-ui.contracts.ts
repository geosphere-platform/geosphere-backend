...
export const RULES_UI_COMPONENTS: Record<string, GeoSphereComponentDefinition> = {
...
export const RULES_READY_MADE_SCREENS: Record<string, GeoSphereScreenDefinition> = {
  RULE_LIST_SCREEN: {
