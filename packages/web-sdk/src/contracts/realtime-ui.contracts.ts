...
export const REALTIME_UI_COMPONENTS: Record<string, GeoSphereComponentDefinition> = {
...
export const REALTIME_READY_MADE_SCREENS: Record<string, GeoSphereScreenDefinition> = {
