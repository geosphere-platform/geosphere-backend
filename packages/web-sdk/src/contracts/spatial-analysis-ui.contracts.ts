...
export const SPATIAL_ANALYSIS_UI_COMPONENTS: Record<string, GeoSphereComponentDefinition> = {
...
export const SPATIAL_ANALYSIS_READY_MADE_SCREENS: Record<string, GeoSphereScreenDefinition> = {
