...
export const TASK_UI_COMPONENTS: Record<string, GeoSphereComponentDefinition> = {
  TASK_CARD: {
    id: "tasks.task-card",
...
export const TASK_READY_MADE_SCREENS: Record<string, GeoSphereScreenDefinition> = {
  TASK_LIST_SCREEN: {
