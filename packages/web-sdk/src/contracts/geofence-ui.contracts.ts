...
export const GEOFENCE_UI_COMPONENTS: Record<string, GeoSphereComponentDefinition> = {
  GEOFENCE_LIST: {
...
export const GEOFENCE_READY_MADE_SCREENS: Record<string, GeoSphereScreenDefinition> = {
