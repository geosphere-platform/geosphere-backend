...
export const ANALYTICS_UI_COMPONENTS: Record<string, GeoSphereComponentDefinition> = {
  HEALTH_INDICATOR: {
...
export const ANALYTICS_READY_MADE_SCREENS: Record<string, GeoSphereScreenDefinition> = {
