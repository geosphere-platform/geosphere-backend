...
export const NOTIFICATIONS_UI_COMPONENTS: Record<string, GeoSphereComponentDefinition> = {
  NOTIFICATION_BELL: {
...
export const NOTIFICATIONS_READY_MADE_SCREENS: Record<string, GeoSphereScreenDefinition> = {
