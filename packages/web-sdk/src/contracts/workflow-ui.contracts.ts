...
export const WORKFLOW_UI_COMPONENTS: Record<string, GeoSphereComponentDefinition> = {
  WORKFLOW_TIMELINE: {
...
export const WORKFLOW_READY_MADE_SCREENS: Record<string, GeoSphereScreenDefinition> = {
