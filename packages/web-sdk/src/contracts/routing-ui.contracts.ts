...
export const ROUTING_UI_COMPONENTS: Record<string, GeoSphereComponentDefinition> = {
  ROUTE_SUMMARY: {
...
export const ROUTING_READY_MADE_SCREENS: Record<string, GeoSphereScreenDefinition> = {
