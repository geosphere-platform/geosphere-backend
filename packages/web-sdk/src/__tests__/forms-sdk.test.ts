...
import {
  GeoSphereFormsSDK,
  GeoSphereFormsConfig,
  GeoSphereMockFormProvider,
  GeoSphereFormsError,
  FORMS_UI_COMPONENTS,
  FORMS_READY_MADE_SCREENS,
...
async function runFormsSdkTests() {
  ...
  const config: GeoSphereFormsConfig = {
    embeddedMode: true,
  ...
  if (!theme.colors.primary) throw new Error("Theme resolution failed for Forms SDK");
  ...
  if (typeof (GeoSphereFormsSDK.prototype as any).createPolygon === "function") {
  ...
  if (typeof (GeoSphereFormsSDK.prototype as any).renderMap === "function") {
  ...
  if (typeof (GeoSphereFormsSDK.prototype as any).watchPosition === "function") {
  ...
  if (typeof (GeoSphereFormsSDK.prototype as any).startTrackingSession === "function") {
  ...
  if (typeof (GeoSphereFormsSDK.prototype as any).evaluateGeofence === "function") {
  ...
  if (typeof (GeoSphereFormsSDK.prototype as any).calculateRoute === "function") {
  ...
  if (typeof (GeoSphereFormsSDK.prototype as any).startTurnByTurn === "function") {
  ...
  if (typeof (GeoSphereFormsSDK.prototype as any).searchPlaces === "function") {
  ...
  if (typeof (GeoSphereFormsSDK.prototype as any).calculateArea === "function") {
  ...
  if (typeof (GeoSphereFormsSDK.prototype as any).createMapPackage === "function") {
  ...
  if (typeof (GeoSphereFormsSDK.prototype as any).createEmployeeForm === "function") {
  ...
  if (typeof (GeoSphereFormsSDK.prototype as any).createVisitForm === "function") {
