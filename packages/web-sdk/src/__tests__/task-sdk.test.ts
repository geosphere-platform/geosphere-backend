...
import {
  GeoSphereTaskSDK,
  GeoSphereTaskConfig,
  GeoSphereMockTaskProvider,
  GeoSphereTaskError,
  TASK_UI_COMPONENTS,
  TASK_READY_MADE_SCREENS,
...
async function runTaskSdkTests() {
  ...
  const config: GeoSphereTaskConfig = {
    embeddedMode: true
  };
  ...
  if (!theme.colors.primary) throw new Error("Theme resolution failed for Task SDK");
  ...
  if (typeof (GeoSphereTaskSDK.prototype as any).createPolygon === "function") {
  ...
  if (typeof (GeoSphereTaskSDK.prototype as any).renderMap === "function") {
  ...
  if (typeof (GeoSphereTaskSDK.prototype as any).watchPosition === "function") {
  ...
  if (typeof (GeoSphereTaskSDK.prototype as any).startTrackingSession === "function") {
  ...
  if (typeof (GeoSphereTaskSDK.prototype as any).evaluateGeofence === "function") {
  ...
  if (typeof (GeoSphereTaskSDK.prototype as any).calculateRoute === "function") {
  ...
  if (typeof (GeoSphereTaskSDK.prototype as any).startTurnByTurn === "function") {
  ...
  if (typeof (GeoSphereTaskSDK.prototype as any).searchPlaces === "function") {
  ...
  if (typeof (GeoSphereTaskSDK.prototype as any).calculateArea === "function") {
  ...
  if (typeof (GeoSphereTaskSDK.prototype as any).createMapPackage === "function") {
  ...
  if (typeof (GeoSphereTaskSDK.prototype as any).createEmployeeTask === "function") {
  ...
  if (typeof (GeoSphereTaskSDK.prototype as any).createVisitTask === "function") {
  ...
  if (!Array.isArray(inProgTasks)) throw new Error("listTasks returned non-array result");
  ...
  try {
    ...
    if (!(e instanceof GeoSphereTaskError) || e.code !== "TASK_NOT_FOUND") throw e;
  }
  ...
  const tenantATask: string = "task_tenant_A";
  const tenantBTask: string = "task_tenant_B";
  if (tenantATask === tenantBTask) throw new Error("Tenant boundary check failed");
