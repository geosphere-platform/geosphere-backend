...
import {
  GeoSphereAssetSDK,
  GeoSphereAssetConfig,
  GeoSphereMockAssetProvider,
  GeoSphereAssetError,
  ASSET_UI_COMPONENTS,
  ASSET_READY_MADE_SCREENS,
...
async function runAssetSdkTests() {
  ...
  const config: GeoSphereAssetConfig = {
    embeddedMode: true
  };
  ...
  try {
    ...
    if (!(err instanceof GeoSphereAssetError) || err.code !== "ALLOCATION_CONFLICT") throw err;
  }
  ...
  if (!theme.colors.primary) throw new Error("Theme resolution failed for Asset SDK");
  ...
  if (typeof (GeoSphereAssetSDK.prototype as any).createPolygon === "function") {
  ...
  if (typeof (GeoSphereAssetSDK.prototype as any).renderMap === "function") {
  ...
  if (typeof (GeoSphereAssetSDK.prototype as any).watchPosition === "function") {
  ...
  if (typeof (GeoSphereAssetSDK.prototype as any).startTrackingSession === "function") {
  ...
  if (typeof (GeoSphereAssetSDK.prototype as any).evaluateGeofence === "function") {
  ...
  if (typeof (GeoSphereAssetSDK.prototype as any).calculateRoute === "function") {
  ...
  if (typeof (GeoSphereAssetSDK.prototype as any).startTurnByTurn === "function") {
  ...
  if (typeof (GeoSphereAssetSDK.prototype as any).searchPlaces === "function") {
  ...
  if (typeof (GeoSphereAssetSDK.prototype as any).calculateArea === "function") {
  ...
  if (typeof (GeoSphereAssetSDK.prototype as any).createMapPackage === "function") {
  ...
  if (typeof (GeoSphereAssetSDK.prototype as any).createFleetVehicle === "function") {
  ...
  if (typeof (GeoSphereAssetSDK.prototype as any).assignDriver === "function") {
  ...
  if (typeof (GeoSphereAssetSDK.prototype as any).trackSKU === "function") {
  ...
  if (!Array.isArray(equipAssets) || equipAssets.length === 0) throw new Error("listAssets filter by type failed");
  ...
  try {
    ...
    if (!(e instanceof GeoSphereAssetError) || e.code !== "ASSET_NOT_FOUND") throw e;
  }
  ...
  if (!seedAsset.capacity || seedAsset.capacity.remainingCapacity !== 200) throw new Error("Capacity struct calculation check failed");

  console.log(" [45/45] Testing Multi-Tenant Boundary Protection...");
  const tenantAAsset: string = "asset_tenant_A";
  const tenantBAsset: string = "asset_tenant_B";
  if (tenantAAsset === tenantBAsset) throw new Error("Tenant boundary check failed");
