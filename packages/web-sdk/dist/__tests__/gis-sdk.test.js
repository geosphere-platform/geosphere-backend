 ...
 */
import { GeoSphereGIS, GIS_UI_COMPONENTS, GIS_READY_MADE_SCREENS, resolveThemePrecedence, validateLocaleConfig, evaluatePermissionState } from "../contracts/index.js";
...
async function runGISSdkTests() {
    ...
    const resolvedTheme = resolveThemePrecedence({
        ...
        tenantConfig: {
            preset: "dark-pro",
            tokens: { colors: { primary: "#3B82F6", background: "#0F172A" } }
        }
    });
...
//# sourceMappingURL=gis-sdk.test.js.map