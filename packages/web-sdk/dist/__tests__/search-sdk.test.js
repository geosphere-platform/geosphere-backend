 ...
 */
import { GeoSphereSearchSDK, GeoSphereMockSearchProvider, InMemorySearchHistoryStore, GeoSphereSearchError, GeoSphereLocationSDK, GeoSphereRoutingSDK, SEARCH_UI_COMPONENTS, SEARCH_READY_MADE_SCREENS, resolveThemePrecedence, validateLocaleConfig, evaluatePermissionState } from "../contracts/index.js";
...
async function runSearchSdkTests() {
    ...
    try {
        ...
        if (!(e instanceof GeoSphereSearchError) || e.code !== "INVALID_QUERY")
            throw e;
    }
    try {
        await searchSdk.reverseGeocode({ coordinate: [] });
        throw new Error("reverseGeocode failed to throw on invalid coordinate");
    }
    catch (e) {
        if (!(e instanceof GeoSphereSearchError) || e.code !== "INVALID_COORDINATE")
            throw e;
    }
    ...
    if (typeof searchSdk.render === "function" || typeof searchSdk.componentDidMount === "function") {
    ...
    const hasOwnRouting = typeof GeoSphereSearchSDK.prototype.calculateRoute === "function";
    if (hasOwnRouting) {
    ...
    const hasOwnNav = typeof GeoSphereSearchSDK.prototype.startNavigation === "function";
    if (hasOwnNav) {
    ...
    const hasOwnGPS = typeof GeoSphereSearchSDK.prototype.getCurrentPosition === "function";
    if (hasOwnGPS) {
    ...
    const hasOwnPoly = typeof GeoSphereSearchSDK.prototype.computeIntersection === "function";
    if (hasOwnPoly) {
    ...
    const hasOwnFence = typeof GeoSphereSearchSDK.prototype.checkPointInGeofence === "function";
    if (hasOwnFence) {
...
//# sourceMappingURL=search-sdk.test.js.map