 ...
 */
import { GeoSphereTrackingSDK, GeoSphereDistanceCalculator, classifyTrackingQuality, TRACKING_UI_COMPONENTS, TRACKING_READY_MADE_SCREENS, resolveThemePrecedence, validateLocaleConfig, evaluatePermissionState } from "../contracts/index.js";
...
async function runTrackingSdkTests() {
    ...
    const mockTelemetryProvider = {
        async sendTrackingPoint(p, s) { sentPointsCount++; },
        async sendTrackingSession(s) { sentSessionCount++; }
    };
    ...
    if (caps.includes("BACKGROUND_TRACKING") || caps.includes("REMOTE_CONTROL")) {
    ...
    if (typeof trackingSdk.render === "function" || typeof trackingSdk.componentDidMount === "function") {
    ...
    const hasOwnNavigatorGeo = typeof GeoSphereTrackingSDK.prototype.getCurrentPosition === "function";
...
//# sourceMappingURL=tracking-sdk.test.js.map