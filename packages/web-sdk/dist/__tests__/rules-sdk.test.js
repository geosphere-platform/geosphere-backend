 ...
 */
import { GeoSphereRulesSDK, GeoSphereMockRulesProvider, GeoSphereRulesError, RULES_UI_COMPONENTS, RULES_READY_MADE_SCREENS, resolveThemePrecedence, validateLocaleConfig, evaluatePermissionState } from "../contracts/index.js";
...
async function runRulesSdkTests() {
    ...
    if (!wfContext.workflowId)
        throw new Error("Workflow SDK integration boundary check failed");
    ...
    if (!taskContext.taskId)
        throw new Error("Task SDK integration boundary check failed");
    ...
    if (!assetContext.assetId)
        throw new Error("Asset SDK integration boundary check failed");
    ...
    if (!schedContext.scheduleId)
        throw new Error("Scheduling SDK integration boundary check failed");
    ...
    if (!formContext.formId)
        throw new Error("Forms SDK integration boundary check failed");
    ...
    if (!newRule.offlineSafe)
        throw new Error("Offline-safe rule configuration check failed");
    ...
    if (!theme.colors.primary)
        throw new Error("Theme resolution failed for Rules SDK");
    ...
    if (validLocale.dateFormat !== "YYYY-MM-DD")
    ...
    if (typeof GeoSphereRulesSDK.prototype.createPolygon === "function") {
    ...
    if (typeof GeoSphereRulesSDK.prototype.renderMap === "function") {
    ...
    if (typeof GeoSphereRulesSDK.prototype.watchPosition === "function") {
    ...
    if (typeof GeoSphereRulesSDK.prototype.startTrackingSession === "function") {
    ...
    if (typeof GeoSphereRulesSDK.prototype.evaluateGeofence === "function") {
    ...
    if (typeof GeoSphereRulesSDK.prototype.calculateRoute === "function") {
    ...
    if (typeof GeoSphereRulesSDK.prototype.startTurnByTurn === "function") {
    ...
    if (typeof GeoSphereRulesSDK.prototype.searchPlaces === "function") {
    ...
    if (typeof GeoSphereRulesSDK.prototype.calculateArea === "function") {
    ...
    if (typeof GeoSphereRulesSDK.prototype.createMapPackage === "function") {
    ...
    if (typeof GeoSphereRulesSDK.prototype.evaluateDriverShift === "function") {
    ...
    if (typeof GeoSphereRulesSDK.prototype.evaluateAttendance === "function") {
    ...
    if (typeof GeoSphereRulesSDK.prototype.evaluateFleetRules === "function") {
    ...
    if (!Array.isArray(tenantRules) || tenantRules.length === 0)
        throw new Error("listRules filter by scope failed");
    ...
    try {
        ...
        if (!(e instanceof GeoSphereRulesError) || e.code !== "RULE_NOT_FOUND")
            throw e;
    }
    ...
    if (config.maxGroupDepth !== 5)
        throw new Error("Configurable max group depth check failed");
    console.log(" [46/47] Testing Multi-Tenant Boundary Protection...");
    const tenantARule = "rule_tenant_A";
    const tenantBRule = "rule_tenant_B";
    if (tenantARule === tenantBRule)
...
//# sourceMappingURL=rules-sdk.test.js.map