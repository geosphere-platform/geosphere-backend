 ...
 */
import { GeoSphereAuthProviderWeb, createAuthorizationContext, evaluatePermissionState, GeoSphereEventBus } from "../contracts/index.js";
...
async function runAuthRbacTests() {
    ...
    const authProvider = new GeoSphereAuthProviderWeb(eventBus, "test_session_key");
    // 1. Initial State
    ...
    const unsubscribe = authProvider.onAuthStateChanged((state) => {
    ...
    if (authProvider.state !== "AUTHENTICATED") {
...
//# sourceMappingURL=auth-rbac.test.js.map