 ...
 */
import { GeoSphereNotificationsSDK, GeoSphereMockNotificationProvider, GeoSphereNotificationsError, NOTIFICATIONS_UI_COMPONENTS, NOTIFICATIONS_READY_MADE_SCREENS, resolveThemePrecedence, validateLocaleConfig, evaluatePermissionState } from "../contracts/index.js";
...
async function runNotificationsSdkTests() {
    ...
    if (!theme.colors.primary)
        throw new Error("Theme resolution failed for Notifications SDK");
    ...
    if (typeof GeoSphereNotificationsSDK.prototype.createPolygon === "function") {
    ...
    if (typeof GeoSphereNotificationsSDK.prototype.renderMap === "function") {
    ...
    if (typeof GeoSphereNotificationsSDK.prototype.watchPosition === "function") {
    ...
    if (typeof GeoSphereNotificationsSDK.prototype.startTrackingSession === "function") {
    ...
    if (typeof GeoSphereNotificationsSDK.prototype.evaluateGeofence === "function") {
    ...
    if (typeof GeoSphereNotificationsSDK.prototype.calculateRoute === "function") {
    ...
    if (typeof GeoSphereNotificationsSDK.prototype.startTurnByTurn === "function") {
    ...
    if (typeof GeoSphereNotificationsSDK.prototype.searchPlaces === "function") {
    ...
    if (typeof GeoSphereNotificationsSDK.prototype.calculateArea === "function") {
    ...
    if (typeof GeoSphereNotificationsSDK.prototype.createMapPackage === "function") {
    ...
    if (typeof GeoSphereNotificationsSDK.prototype.connectWebSocket === "function") {
    ...
    try {
        ...
        if (!(e instanceof GeoSphereNotificationsError) || e.code !== "TOKEN_INVALID")
            throw e;
    }
    ...
    try {
        ...
        if (!(e instanceof GeoSphereNotificationsError) || e.code !== "NOTIFICATION_NOT_FOUND")
            throw e;
    }
    ...
    if (unreadAfterMarkAll !== 0)
        throw new Error("markAllAsRead failed to set unread count to 0");
    ...
    if (config.pageSize !== 10)
        throw new Error("pageSize config check failed");
...
//# sourceMappingURL=notifications-sdk.test.js.map